...
def destroy_container_view(view_ref):
    # destroy view
    view_ref.Destroy()
...
def parse_properties(props, include_mors=False, key=None):
    # Parse properties
    data = []
    for obj in props:
        properties = {}
    ...
    return dict([(o[key], o) for o in data if key in o]) if key else data
